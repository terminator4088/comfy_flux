...
huggingface-cli download black-forest-labs/FLUX.1-dev text_encoder/model.safetensors vae/diffusion_pytorch_model.safetensors
touch /workspace/hf_download_1.fin) &> hf_download_1.log

(huggingface-cli download black-forest-labs/FLUX.1-dev flux1-dev.safetensors
touch /workspace/hf_download_2.fin) &> hf_download_2.log

(huggingface-cli download XLabs-AI/flux-RealismLora lora.safetensors
touch /workspace/hf_download_3.fin) &> hf_download_3.log

(huggingface-cli download InstantX/FLUX.1-dev-Controlnet-Union diffusion_pytorch_model.safetensors
touch /workspace/hf_download_4.fin) &> hf_download_4.log
